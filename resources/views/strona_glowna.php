...
?>
    ...
    <div class="container" style = "margin:0; width:100%; margin-top:2%;">
        <div class="row">
                ...
                <div class="card-body"> <!-- karta pierwsza -->
                    <div class = "row">
                        ...
                        <div class= "col-lg-5 col-md-6 col-sm-5 col-5">
                                ...
                                <a class="btn btn-default btn-dark" href="historia.php" role="button" style="width:30%">Historia</a>
                                <a class="btn btn-default btn-dark" href="przelew.php" role="button" style="width:66%">Przelew</a>
